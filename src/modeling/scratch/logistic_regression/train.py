...
from src.modeling.scratch.logistic_regression.model import LogisticRegressionScratch
...
def train():
    ...
    # ===================== Lib (sklearn) =====================
    from src.modeling.lib.logistic_regression.model import create_logistic_regression
