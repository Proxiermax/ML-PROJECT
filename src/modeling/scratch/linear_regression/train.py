...
from src.modeling.scratch.linear_regression.model import LinearRegressionScratch
...
def train():
    ...
    # ===================== Lib (sklearn) =====================
    from src.modeling.lib.linear_regression.model import create_linear_regression

    print("\n" + "=" * 60)
    print("Linear Regression (lib / sklearn)")
    print("=" * 60)

    sk_model = create_linear_regression()
    ...
    # ===================== Comparison =====================
    compare_regression(scratch_metrics, lib_metrics, model_name="Linear Regression")
