...
from src.modeling.regression.scratch.multiple_regression.model import MultipleRegressionScratch
...
def train():
    ...
    model = MultipleRegressionScratch(learning_rate=0.001,n_iterations=5000)
    ...
    MODEL_DIR = PROJECT_ROOT / "models" / "regression" / "scratch" / "multiple_regression"
