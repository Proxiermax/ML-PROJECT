...
from src.modeling.multiple_regression.model import MultipleLinearRegressionScratch
...
def train():
    ...
    scratch_model = MultipleLinearRegressionScratch(
        learning_rate=0.001,
        n_iterations=5000
    )
    ...
    y_train_pred_lib = sklearn_model.predict(X_train)
    y_test_pred_lib = sklearn_model.predict(X_test)
    ...
    scratch_path = MODEL_DIR / "multiple_regression_scratch.pkl"
    sklearn_path = MODEL_DIR / "multiple_regression_sklearn.pkl"
...
from src.data.regression_data import load_regression_data
from src.modeling.regression.scratch.multiple_regression.model import MultipleLinearRegressionScratch
