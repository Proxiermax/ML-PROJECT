...
from src.modeling.regression.lib.poly_regression.model import PolynomialRegressionSklearn
...
def train():
    ...
    model = PolynomialRegressionSklearn(degree=2)
    ...
    MODEL_DIR = PROJECT_ROOT / "models" / "regression" / "lib" / "poly_regression"
