...
from src.modeling.classification.lib.slp.model import create_slp
...
def train():
    ...
    print("=" * 60)
    print("Single-Layer Perceptron (sklearn)")
    print("=" * 60)
    print(f"Train samples: {X_train.shape[0]}  |  Test samples: {X_test.shape[0]}")

    model = create_slp(max_iter=1000, random_state=42)
    ...
    MODEL_DIR = PROJECT_ROOT / "models" / "classification" / "lib" / "slp"
