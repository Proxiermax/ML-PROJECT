...
from src.modeling.classification.lib.pca_random_forest.model import create_random_forest
...
def train():
    ...
    print("=" * 60)
    print("Random Forest + PCA (sklearn)")
    print("=" * 60)
    ...
    MODEL_DIR = PROJECT_ROOT / "models" / "classification" / "lib" / "pca_random_forest"
