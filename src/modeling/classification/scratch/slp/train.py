...
from src.modeling.classification.scratch.slp.model import SLPScratch
...
def train():
    ...
    print("=" * 60)
    print("Single-Layer Perceptron (from scratch)")
    print("=" * 60)
    print(f"Train samples: {X_train.shape[0]}  |  Test samples: {X_test.shape[0]}")

    model = SLPScratch(learning_rate=0.01, n_iterations=1000, random_state=42)
    ...
    MODEL_DIR = PROJECT_ROOT / "models" / "classification" / "scratch" / "slp"
