...
from src.modeling.custom_classification.model import KNNScratch
...
def train():
    ...
    print("=" * 60)
    print("KNN — Custom / Better Classification Model (from scratch)")
    print("=" * 60)
    ...
    model_path = Path("models/custom_classification_model.pkl")
...
from src.data.classification_data import load_classification_data
from src.modeling.classification.custom_classification.model import KNNScratch
