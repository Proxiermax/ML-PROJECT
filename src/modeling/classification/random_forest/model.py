<<<<<<<< HEAD:src/modeling/classification/random_forest_classification/model.py
import numpy as np
...
class RandomForestScratch:
    ...
    def feature_importance(self, feature_names=None):
        ...
        if feature_names is not None:
            return dict(zip(feature_names, importance))
        return importance
>>>>>>>> 9cd2b7bb09c88492b3866ff4ea032d8880b3619e:src/modeling/classification/random_forest/model.py
