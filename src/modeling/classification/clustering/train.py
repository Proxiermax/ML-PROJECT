<<<<<<<< HEAD:src/modeling/classification/clustering_classification/train.py
import pickle
import numpy as np
...
from src.data.classification_data import load_classification_data
from src.modeling.classification.clustering.model import KMeansScratch, AgglomerativeScratch
...
if __name__ == "__main__":
    train()
>>>>>>>> 9cd2b7bb09c88492b3866ff4ea032d8880b3619e:src/modeling/classification/clustering/train.py
